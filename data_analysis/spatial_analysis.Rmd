...
```{r, vis_top_spatial}
svf.rank <- anterior1.cluster3@assays$SCT@meta.features[order(anterior1.cluster3@assays$SCT@meta.features$markvariogram.spatially.variable.rank),]
svf.rank[1:10,]

lapply(rownames(svf.rank)[1:10], function(feature){
    SpatialFeaturePlot(anterior1.cluster3, features = feature, crop = FALSE)
})

lapply(rownames(svf.rank)[c(1,5:7,10)], function(feature){
